...
public class PensionerDetaiMicroserviceApplication {
	...
	CommandLineRunner run(PensionerDetailsServiceImpl pensionservice) {
		...
		return args -> {
			...
			pensionservice.savePensionerDetails(new PensionerDetails(
					null,"Toast",date.parse("22/04/1990"),"1234567891",19000L,323445L,"Family","123456789012",new BankDetails(null,"Indian Bank","563456789012345","Public")));
			pensionservice.savePensionerDetails(new PensionerDetails(
					null,"Abe",date.parse("28/05/1998"),"1235467892",100400L,2345L,"Self","456785345678",new BankDetails(null,"State Bank","123460237654321","Public")));
			pensionservice.savePensionerDetails(new PensionerDetails(
			...
			pensionservice.savePensionerDetails(new PensionerDetails(
					null,"Pam",date.parse("28/05/1998"),"1235467895",100030L,42345L,"Family","456785345678",new BankDetails(null,"State Bank","903460987654321","Public")));
			pensionservice.savePensionerDetails(new PensionerDetails(
					null,"Bob",date.parse("27/03/1997"),"1236409877",10002340L,42345L,"Family","456784098765",new BankDetails(null,"ICICI Bank","803471234509876","Private")));
			pensionservice.savePensionerDetails(new PensionerDetails(
					null,"Peter",date.parse("29/04/1999"),"1234567898",1002400L,3245L,"Self","123456789012",new BankDetails(null,"Indian Bank","603456789012345","Public")));
			pensionservice.savePensionerDetails(new PensionerDetails(
					null,"Logan",date.parse("28/05/1998"),"1235467899",1000240L,4245L,"Family","456785345678",new BankDetails(null,"State Bank","203460987654321","Public")));
			pensionservice.savePensionerDetails(new PensionerDetails(
